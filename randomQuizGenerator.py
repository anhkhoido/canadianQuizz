...
from customNumbers import IndexGenerator
import random
...
def create_each_quizz(directory_for_quizzes, directory_for_answer_keys):
    ...
    for quizNumber in range(35):
        ...
        for index in range(len(list_of_provinces)):
            ...
            wrong_answer001 = IndexGenerator.generate_random_number_for_wrong_answer(index, -1, -1, len(list_of_provinces))
            wrong_answer002 = IndexGenerator.generate_random_number_for_wrong_answer(index, wrong_answer001, -1, len(list_of_provinces))
            wrong_answer003 = IndexGenerator.generate_random_number_for_wrong_answer(index, wrong_answer001, wrong_answer002, len(list_of_provinces))
